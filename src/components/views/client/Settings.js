...
export default class Settings extends Component {
	...
	_updateProfile = () => {
		this.props.navigation.navigate('UpdateProfile',{onUpdateProfile: this._onUpdateProfile.bind(this), onUpdateAvatar: this._onUpdateAvatar.bind(this)})
	}	
				...
				<View style={{flexDirection:'row', alignItems:'center', width:width, padding:16, borderBottomWidth:1, borderColor:'#cfcfcf'}}>
					<Image 
          			...
          			<View>
          				...
          				<Text style={{fontSize:12,marginTop:4}}>{this.state.profile.phone}</Text>
          			</View>
				</View>
				<CardMenu iconName="person" title="Profil Saya" onPress={this._updateProfile}/>
